...
Navega a facebook.com/groups/?category=joined, hace scroll y extrae IDs.
"""
...
def discover_groups_for_account(account: AccountConfig, config: dict) -> list[dict]:
    """
    Descubre grupos de una cuenta navegando a facebook.com/groups/?category=joined,
    ...
    try:
        ...
        results = poster.page.evaluate(f"() => {DISCOVERY_JS}")
